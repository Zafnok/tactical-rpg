...
| ----- | --------- | ------- | ------- |
| `00xx` | Design decisions | Nick's answers recorded in `docs/design/` | 0001–0012 |
...
| `03xx` | M2 Core rules | Maps, units, pathfinding, combat, turns, items, rewind — pure and heavily tested | 0301–0307 |
| `04xx` | M3 Battle UI | Cursor, move/attack loop, forecast, combat playback, info screens, tips | 0401–0406 |
...
2. **0005** level ups & classes (after 0001) · **0008** world structure · **0009** Chapter 1 scope (after 0007)
...
Sign-offs come later as screens land (0402 cursor feel, 0404 combat, 0502 enemy
