...
| [0006](0006-input-actions-and-virtual-cursor.md) | Input actions, vim-style keymap, virtual cursor | Accepted |
| [0007](0007-testing-strategy.md) | Testing strategy | Accepted |
| [0008](0008-ci-quality-gates.md) | CI and quality gates (free tier only) | Accepted |
